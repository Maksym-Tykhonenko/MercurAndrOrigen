...
/////////////////////////
import MercurAndrOrigenProductScreen from './src/screens/MercurAndrOrigenProductScreen';
...
export const App = () => {
  ...
  const INITIAL_URL = `https://spielbank-hohensyburg-cas.com/`;
  const URL_IDENTIFAIRE = `qp78CK3k`;
  ...
  OneSignal.initialize('bbc5d2e1-1ea4-4bac-8a52-b846a656935f');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="MercurAndrOrigenProductScreen"
            component={MercurAndrOrigenProductScreen}
            options={{headerShown: false}}
          />
        </Stack.Navigator>
      );
      ...
      <NavigationContainer>
        {!louderIsEnded || !aceptTransperency || !completeLink ? (
          <View
            ...
            <Animated.Image
              source={require('./src/assets/louder1.jpg')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./src/assets/louder2.jpg')}
              style={{
                //...props.style,
